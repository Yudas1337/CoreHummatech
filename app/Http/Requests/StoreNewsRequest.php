...
class StoreNewsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'thumbnail' => 'mimes:png,jpg,gif|required',
            'tags' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'thumbnail.mimes' => 'Format gambar tidak valid. Harap pilih format jpeg, png, atau jpg',
            'thumbnail.required' => 'Harap pilih thumbnail gambar',
