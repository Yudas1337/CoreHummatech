        ...
        <div class="card border-0 shadow p-3 mt-3">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <h4 class="m-2">Kategori Testimonial</h4>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="d-flex justify-content-lg-end justify-content-start">
                        ...
                        @include('admin.pages.testimonial-category.create')
                    </div>
                </div>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2 align-items-center">
                            @include('admin.pages.testimonial-category.edit')
                            @include('admin.pages.testimonial-category.delete')
                        </div>
                    </td>
                </tr>
                <tr>
