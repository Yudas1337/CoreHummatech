              ...
              <div class="modal-body">
                  <div class="row g-2">
                      <div class="mb-3 mt-0 col-md-12">
                          ...
                          <input class="form-control" type="text" required="" autocomplete="name" placeholder="Masukkan Nama Platform">
                      </div>
                      <div class="mb-3 mt-0 col-md-12">
                          <label for="bm-title">Tautan Media Sosial</label>
                          <input class="form-control" type="text" required="" autocomplete="name" placeholder="Masukkan Tautan Media Sosial">
                      </div>
                      <div class="mb-3 mt-0 col-md-12">
