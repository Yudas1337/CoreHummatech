                    ...
                    <div class="card shadow-sm">
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                <small style="font-size: 10px"><span class="text-primary pe-2 fw-bold">Magang</span>Kamis,
                                    20 Februari 2024</small>
                                <a href="/news">
                                    <h4>Judul berita</h4>
                                </a>
                                ...
                                <div class="d-flex gap-1 mb-3">
                                    <small class="text-primary"
                                        style="background-color:#DEEBFF; padding: 3px 10px; border-radius:5px">Keseruan</small>
                                    <small class="text-primary"
                                        style="background-color:#DEEBFF; padding: 3px 10px; border-radius:5px">Camping</small>
                                </div>
