    ...
    <div class="modal fade modal-bookmark" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="form-bookmark needs-validation" action="{{ route('create.team') }}" method="POST" id="bookmark-form" novalidate=""
                        ...
                        <div class="row g-2">
                            ...
                            <div class="mb-3 mt-0 col-md-12">
                                ...
                                <select id="departement" name="position_id" class="form-select">
                                    ...
                                    @empty
                                    <option value="null" disabled="disabled" selected="selected">Jabatan Masih Kosong</option>
                                    @endforelse
                                </select>
                            </div>
                            <div class="mb-3 mt-0 col-md-12">
        ...
        <div class="card social-profile m-0">
            ...
            <div class="card-body">
                <div class="social-img-wrap">
                    <div class="social-img"><img src="{{ asset('storage/' . $team->image) }}" width="100px" height="200px" style="object-fit: cover ; height:100px" alt="profile">
                    </div>
                    <div class="edit-icon">
                        <svg>
                ...
                <div class="social-details">
                    <h5 class="mb-1"><a href="social-app.html">{{ $team->name }}</a></h5><span class="f-light">{{ $team->position->name }}</span>
                </div>
            </div>
        </div>
        @empty
