...
@section('content')
            ...
            <div class="card social-profile m-0">
                ...
                <div class="card-body">
                    ...
                    <div class="social-details">
                        <h5 class="mb-1"><a href="social-app.html">User Name</a></h5><span class="f-light">Lorem
                            ipsum</span>
                    </div>
                </div>
            </div>
    ...
    <!-- Edit Modal -->
    <div class="modal fade modal-bookmark" id="edit-data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="form-bookmark needs-validation" action="#" method="POST" id="bookmark-form"
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-center">
                            <img src="{{ asset('assets/images/dashboard-8/profile.png') }}" height="96px" width="96px" class="mb-4"
                                alt="profile">
                        </div>
