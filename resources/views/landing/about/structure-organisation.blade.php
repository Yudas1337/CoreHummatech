...
@section('content')
    <div class="breadcrumb-area text-center shadow dark text-light bg-cover"
        style="background-image: url({{ $background->show_in == 'Tentang Kami' && $background->about_in == 'Struktur Organisasi' ? asset('storage/'. $background->image) : asset('assets-home/img/default-bg.png') }});">
        <div class="container">
            <div class="row">
