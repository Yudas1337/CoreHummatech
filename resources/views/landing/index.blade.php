                            ...
                            @forelse ($product as $produk)
                                ...
                                <div class="single-item">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-center">
                                                <img class="img-fluid" src="{{ asset('storage/' . $produk->image) }}"
                                                    alt="" srcset="">
                                            </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-6 single-item">
                                                            <div class="item">
                                                                <div class="thumb">
                                                                    <div id="carouselImages" class="carousel slide"
                                                                        ...
                                                                        <div class="carousel-inner">
                                                                            ...
                                                                            @php
                                                                                $newsImages = \App\Models\NewsImage::where(
                                                                                    'news_id',
                                                                                    $newsItem['id'],
                                                                                )->get();
                                                                            @endphp
                                                                            @foreach ($newsImages as $imageIndex => $image)
                                                                                <div
                                                                                    class="carousel-item @if ($imageIndex == 0) active @endif">
                                                                        ...
                                                                        <a class="carousel-control-prev"
                                                                            href="#carouselImages" role="button"
                                                                            data-slide="prev">
                                                                ...
                                                                <div class="info">
                                                                    ...
                                                                    <h4>
                                                                        <a
                                                                            href="blog-single-with-sidebar.html">{{ $newsItem['title'] }}</a>
                                                                    </h4>
                                                                    <p class="line-clamp">{!! Str::limit($newsItem['description'], 80) !!}
                                                                    </p>
                                                                    <a href="/berita/{{ $newsItem->slug }}"
                                                                        class="btn btn-outline-primary rounded-pill py-2 px-4 text-dark">Baca
                                                                        Selengkapnya</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div id="portfolio-grid" class="gallery-items colums-3">
                                            ...
                                            <div class="pf-item">
                                                <div class="item">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="button">
                                                            <a href="assets/images/big-lightgallry/01.jpg"
                                                                class="item popup-gallery">
                                                                <i class="fas fa-plus"></i>
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="pf-item">
                                                <div class="item">
                                                    ...
                                                    <div class="content">
                                                        <div class="info">
                                                            <h4><a href="project-single.html">Assets For Technology</a>
                                                            </h4>
                                                            <span>Invest, Earning</span>
                                                        </div>
                                                        <div class="button">
                                                            <a href="assets/images/big-lightgallry/02.jpg"
                                                                class="item popup-gallery">
                                                                <i class="fas fa-plus"></i>
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="pf-item">
                                                <div class="item">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="button">
                                                            <a href="assets/images/big-lightgallry/03.jpg"
                                                                class="item popup-gallery">
                                                                <i class="fas fa-plus"></i>
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="pf-item">
                                                <div class="item">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="button">
                                                            <a href="assets/images/banner/2.jpg"
                                                                class="item popup-gallery">
                                                                <i class="fas fa-plus"></i>
                                                            </a>
                                                        </div>
